<div class="wrap" id="featurs_tables">
  <div id="featurs_table1">
    <span>WordPress 3.4+ ready</span>
    <span>Responsiveness</span>
    <span>Unlimited number of post sliders</span>
    <span>Static Posts Slider</span>
    <span>Dynamic Posts Slider</span>
    <span>Advanced Filters for dynamic post slider</span>
    <span>Custom posts support</span>
    <span>Linking post slides to URLs</span>
    ...
    <span>Navigation buttons/bullet styles</span>
...
<div style="float: left; clear: both;">
  ...
  <ol>
    <li>Deactivate Post Slider by 10Web plugin.</li>
    <li>Delete Post Slider by 10Web plugin.</li>
